...
function desencriptarTexto(mensaje){
    ...
    for(var i = 0; i < texto.length; i++){
        ...
        else if(texto[i] == "e"){textoFinal = textoFinal + "e", i = i+4;
        }
        else if(texto[i] == "i"){textoFinal = textoFinal + "i", i = i+3;
        }
        else if(texto[i] == "o"){textoFinal = textoFinal + "o", i = i+3;
        }
        else if(texto[i] == "u"){textoFinal = textoFinal + "u", i = i+3;
        }
        else{textoFinal = textoFinal + texto[i];
        }
    }
